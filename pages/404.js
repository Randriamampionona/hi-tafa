	...
	return (
		<section className="relative flex flex-col items-center justify-center w-screen h-screen bg-darkWhite">
			...
			<p className="text-base text-darkBlue text-center max-w-[80%] sm:max-w-[60%] md:max-w-[45%] lg:max-w-[35%] xl:max-w-[25%]">
				Looks like something went wrong or the page you are trying to
			...
			<button className="flex items-center justify-center gap-x-3 rounded mt-10 px-6 py-2 text-white shadow shadow-darkBlue bg-darkBlue hover:bg-darkBlue/95" onClick={() => replace("/")}>
				<span>
					<FaArrowLeft />
				</span>
